      ...
      <section className="features-section relative z-10">
        ...
        <div className="features-grid relative mt-8" style={{ padding: '0 16px' }}>
          <FadeIn delay={0.1} style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
            <div className="feature-card relative z-10" style={{ height: '100%', flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'flex-start', boxSizing: 'border-box' }}>
              <div className="feature-icon">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>
              </div>
              <h3 className="feature-title">{t.track1Title}</h3>
              <p className="feature-subtitle" style={{ flex: 1 }}>{t.track1Sub}</p>
              <Link href="/sponsor" className="btn btn-outline feature-btn" style={{ marginTop: 'auto' }}>{t.track1Btn}</Link>
            </div>
          </FadeIn>
          ...
          <FadeIn delay={0.2} style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
            <div className="feature-card relative z-10" style={{ height: '100%', flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'flex-start', boxSizing: 'border-box' }}>
              ...
              <p className="feature-subtitle" style={{ flex: 1 }}>{t.track2Sub}</p>
              <Link href="/stand" className="btn btn-outline feature-btn" style={{ marginTop: 'auto' }}>{t.track2Btn}</Link>
            </div>
          </FadeIn>
          ...
          <FadeIn delay={0.3} style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
            <div className="feature-card relative z-10" style={{ height: '100%', flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'flex-start', boxSizing: 'border-box' }}>
              ...
              <p className="feature-subtitle" style={{ flex: 1 }}>{t.track3Sub}</p>
              <Link href="/badge" className="btn btn-outline feature-btn" style={{ marginTop: 'auto' }}>{t.track3Btn}</Link>
            </div>
          </FadeIn>
        </div>
      </section>
