    ...
    <>
      ...
      <section className="features-section relative z-10">
        ...
        <div className="features-grid relative mt-16" style={{ padding: '0 32px' }}>
          <FadeIn delay={0.1} className="feature-card relative z-10" style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', background: 'rgba(22, 22, 24, 0.4)', padding: '32px', borderRadius: 'var(--radius-card)', border: '1px solid rgba(255,255,255,0.08)' }}>
          ...
          <FadeIn delay={0.2} className="feature-card relative z-10" style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', background: 'rgba(22, 22, 24, 0.4)', padding: '32px', borderRadius: 'var(--radius-card)', border: '1px solid rgba(255,255,255,0.08)' }}>
            <div className="feature-icon">
          ...
          <FadeIn delay={0.3} className="feature-card relative z-10" style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', background: 'rgba(22, 22, 24, 0.4)', padding: '32px', borderRadius: 'var(--radius-card)', border: '1px solid rgba(255,255,255,0.08)' }}>
            <div className="feature-icon">
        ...
        <div className="features-grid relative mt-8">
          {t.about.axes.map((axis: { title: string; desc: string }, i: number) => (
            <FadeIn 
              ...
              style={{ padding: '40px 32px', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', background: 'rgba(22, 22, 24, 0.7)' }}
            >
